...
//     const { id: lastMessageId } = await openai.beta.threads.messages.create(threadId, {
//       role: "user",
//       content: message,
//     });
...
//   async (ctx, { sessionId, threadId }: { sessionId: string; threadId: string }) => {
...
// //         return;
// //       case "completed": {
// //         const { data: newMessages } = await openai.beta.threads.messages.list(threadId, {
// //           after: lastMessageId,
// //           order: "asc",
// //         });
